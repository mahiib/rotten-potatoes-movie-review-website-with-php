...
if(isset($_SESSION['visitscifi']))
{
  header("Location: scifigenre.php");
}
$_SESSION['visitscifi']='yes';
...
<body>
    ...
    <div style='transform: scale(0.65); position: relative; top: -100px;'>
                ...
                <h3>Which Director do you think has the most entries in this list?</h3>
                <p>Choose 1 answer</p>
                <hr />
