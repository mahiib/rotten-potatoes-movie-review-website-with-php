...
if(isset($_SESSION['visitcomedy']))
{
  header("Location: comedygenre.php");
}
$_SESSION['visitcomedy']='yes';
...
<body>
    ...
    <div style='transform: scale(0.65); position: relative; top: -100px;'>
                ...
                <h3>What do you think is the top rated?</h3>
                <p>Choose 1 answer</p>
                <hr />
                ...
                <div id='block-11' style='padding: 10px;'>
                  <label for='option-11' style=' padding: 5px; font-size: 2.5rem;'>
                    ...
                    Monthy Python and the Holy Grail</label>
