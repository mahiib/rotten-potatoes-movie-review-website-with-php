    ...
    <main>
        <div class="banner">
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" style="text-align: center;">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="./posters/silicon.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <div class="row">
                                <div class="col">
                                    <img src="./posters/siliconv.jpg" alt="" class="poster">
                                </div>
                                <div class="co">
            ...
            <div class="container-description" style="margin: 30px;">
                <h4><i>Genre:</i>&nbsp; Comedy</h4>
                <br/>
                <h4><i>Creators:</i>&nbsp; John Altschuler, Mike Judge, Dave Krinsky</h4>                        
                <br/>
                <h4><i>Starring:</i>&nbsp; Thomas Middleditch, TJ Miller, Josh Brener, Kumail Nanjiani and (more)</h4>
                <br/>
                <h4><i>Year:</i>&nbsp; 2014-2019</h4>
                <br/>
                <h4><i>OTT:</i>&nbsp; Disney+Hotstar</h4>
                <br/>
                <h4>
                <i>Rating:</i>&nbsp;
                <?php
                    ...
                    $query="select * from ratings where name='siliconvalley'";
                    ...
                    if($_SERVER['REQUEST_METHOD']=="POST")
                    {
                        ...
                        $userscount++;
                        $newquery="update ratings set rating='$newrating' where name='siliconvalley'";
                        $newquery2="update ratings set usercount='$userscount' where name='siliconvalley'"; 
            ...
            <h6><p>&nbsp;&nbsp;&nbsp;Richard, a programmer, creates an app called the Pied Piper and tries to get investors for it. Meanwhile,
                 five other programmers struggle to make their mark in Silicon Valley.</p></h6>
                </div>
        </div>
    </main>
    <?php 
