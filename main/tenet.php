    ...
    <main>
        <div class="banner">
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" style="text-align: center;">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="./posters/tenet.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <div class="row">
                                <div class="col">
                                    <img src="./posters/tenetv.jpg" alt="" class="poster">
                                </div>
                                <div class="co">
                                    <h1>TENET</h1>
                                </div>
            ...
            <div class="container-description" style="margin: 30px;">
                <h4><i>Genre:</i>&nbsp; Sci-Fi, Action</h4>
                <br/>
                <h4><i>Director:</i>&nbsp; Christopher Nolan</h4>                        
                <br/>
                <h4><i>Starring:</i>&nbsp; John David Washington, Robert Pattinson, Elizabeth Debicki and (more)</h4>
                <br/>
                <h4><i>Year of Release:</i>&nbsp; 2020</h4>
                <br/>
                <h4><i>Box Office:</i>&nbsp; $364 million</h4>
                <br/>
                <h4>
                <i>Rating:</i>&nbsp;
                <?php
                    ...
                    $query="select * from ratings where name='tenet'";
                    ...
                    if($_SERVER['REQUEST_METHOD']=="POST")
                    {
                        ...
                        $userscount++;
                        $newquery="update ratings set rating='$newrating' where name='tenet'";
                        $newquery2="update ratings set usercount='$userscount' where name='tenet'"; 
            ...
            <h6><p>&nbsp;&nbsp;A secret agent is given a single word as his weapon and sent to prevent the onset of World War III.
                 He must travel through time and bend the laws of nature in order to be successful in his mission.</p></h6>
                </div>
        </div>
    </main>
    <?php 
